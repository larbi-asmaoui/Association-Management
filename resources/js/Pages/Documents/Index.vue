<template>
    ...
    <div class="px-2 pt-2">
        <div class="grid grid-cols-1 px-3 pt-2 xl:grid-cols-3 xl:gap-4">
            ...
            <div class="col-span-2 bg-white max-h-96 overflow-y-auto">
                <h2 class="uppercase text-gray-600 mb-2 px-4 pt-4 italic">
                    Rapports :
                </h2>
                <Vue3EasyDataTable
                    :headers="headers"
    ...
    <a
        class="inline-flex mt-6 items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"
