...
const calendarOptions = reactive({
    ...
    // select: (arg) => {
    //     alert("Selected: " + arg.start + " " + arg.end);
    // },

    select: (arg) => {
        form.start = arg.start.toISOString().slice(0, 10);
        form.end = arg.end.toISOString().slice(0, 10);
        toggleModal();
        console.log(toRaw(props.evenements));
    },
...
// const addEventModalState = reactive({
//     showModal: false,
//     start: null,
//     end: null,
//     title: "",
...
//     addEventModalState.start = info.startStr;
//     addEventModalState.end = info.endStr;
//     addEventModalState.showModal = true;
// }

// function closeAddEventModal() {
//     addEventModalState.showModal = false;
// }

// function addEvent() {
//     if (addEventModalState.title.trim() !== "") {
//         calendarOptions.events.push({
//             title: addEventModalState.title,
//             start: addEventModalState.start,
//             end: addEventModalState.end,
//         });
//         closeAddEventModal();
//     } else {
