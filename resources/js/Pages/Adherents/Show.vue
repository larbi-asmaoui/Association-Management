      ...
      <div id="card" class="py-4 rounded-lg border border-cyan-950">
        ...
        <div class="flex justify-between items-start px-2">
          <div>
            ...
            <p class="text-slate-600 text-2xl">
              Nom:
              <span class="text-black font-bold">{{ adherent.last_name }}</span>
            </p>
            <p class="text-slate-600 text-2xl">
              CIN:
              <span class="text-black font-bold">{{ adherent.cin }}</span>
            </p>
            <p class="text-slate-600 text-2xl">
              Téléphone:
              <span class="text-black font-bold">{{ adherent.tel }}</span>
            </p>
          </div>
          <div>
            <p class="text-slate-600 text-2xl">
