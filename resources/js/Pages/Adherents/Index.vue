          ...
          <button
            @click="
              printJS({
                ...
                type: 'json',
                header:
                  '<h3 class=\'text-2xl font-semibold text-center\'>Liste des adhérents</h3>',
              })
            "
        ...
        <template #body>
          ...
          >
            ...
            <div>
              ...
              >
                <option disabled value="">Séléctionner statut</option>
                <option
                  ...
                  <th
                    @click="
                      printJS({
                        ...
                        type: 'json',
                        header:
                          '<h3 class=\'text-2xl font-semibold text-center\'>Liste des adherents</h3>',
                      })
                    "
                    scope="col"
