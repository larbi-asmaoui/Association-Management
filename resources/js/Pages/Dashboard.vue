  ...
  datasets: [
    {
      ...
      data: Object.values(stocksGroupedByType).map((stocks) => stocks.length),
      ...
      <div class="mt-4">
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div class="bg-white p-4 shadow-2xl rounded-md">
            <ChartPie :data="dataRevenue" :options="revenueOptions" />
          </div>
          <div class="bg-white p-4 shadow-2xl rounded-md">
            <ChartPie :data="dataDepense" :options="depenseOptions" />
          </div>
        </div>
      </div>
