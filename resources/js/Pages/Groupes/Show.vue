    ...
    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            >
                ...
                <span class="tracking-wide">Informations de groupe</span>
            </div>
            <div class="text-gray-700">
                <div class="grid md:grid-cols-2 text-sm">
                    <div class="grid grid-cols-2">
                        <div class="px-4 py-2 font-semibold">Nom de Groupe</div>
                        <div class="px-4 py-2">{{ groupe.name }}</div>
                    </div>
                    <div class="grid grid-cols-2">
                        <div class="px-4 py-2 font-semibold">
                            Date de creation
                        </div>
                        <div class="px-4 py-2">{{ groupe.createdAt }}</div>
                    </div>
                    <div class="grid grid-cols-2">
                        <div class="px-4 py-2 font-semibold">Description</div>
                        <div class="px-4 py-2">{{ groupe.description }}</div>
                    </div>
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="px-4 py-2">{{ groupe.adherants }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        >
            ...
            <div class="mr-3">
                <button
                    @click="$inertia.visit(route('groupes.edit', groupe.id))"
                    type="button"
